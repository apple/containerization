...
extension Initd: Com_Apple_Containerization_Sandbox_V3_SandboxContext.SimpleServiceProtocol {
    ...
    func copyIn(
        request: GRPCCore.RPCAsyncSequence<Com_Apple_Containerization_Sandbox_V3_CopyInChunk, any Swift.Error>,
        context: GRPCCore.ServerContext
    ...
    func copyOut(
        ...
        response: GRPCCore.RPCWriter<Com_Apple_Containerization_Sandbox_V3_CopyOutChunk>,
        context: GRPCCore.ServerContext
    ) async throws {
        ...
        do {
            ...
            while true {
                ...
                try await response.write(.with { $0.content = .data(data) })
